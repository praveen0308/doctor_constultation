...
import 'package:doctor_consultation/ui/widgets/timeline/template_timeline_child2.dart';
import 'package:flutter/cupertino.dart';
import 'package:timeline_tile/timeline_tile.dart';

class ViewEducationTimelineFirst extends StatelessWidget {
  final String txtYear;
  final String txtMonth;
  final String txtTitle;
  final String txtSubTitle;

  const ViewEducationTimelineFirst({
    Key? key,
    this.txtYear = "YYYY",
    this.txtMonth = "MM",
    this.txtTitle = "Title",
