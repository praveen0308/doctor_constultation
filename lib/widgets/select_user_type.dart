...
class TemplateSelectUserType extends StatefulWidget {
  final String imgURL;
  ...
  @override
  State<TemplateSelectUserType> createState() => _TemplateSelectConsultationState();
}

class _TemplateSelectConsultationState extends State<TemplateSelectUserType> {
