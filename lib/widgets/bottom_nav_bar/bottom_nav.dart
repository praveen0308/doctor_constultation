...
import 'package:doctor_consultation/user/admin/schedule/set_schedule.dart';
import 'package:doctor_consultation/widgets/sliding_panel.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

import '../../user/patient/appointment/new_appointment.dart';
import '../../user/patient/dashboard/message_page.dart';
import '../../user/patient/dashboard/patient_profile_page.dart';
    ...
    return Container(
      ...
      child: Stack(children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    BottomTabBtn(
                      ...
                      onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context)=>PatientProfilePage())), //SlidingUpPanelExample()
                    ),
                  ],
                ),
              ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          InkWell(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LayoutSetSchedule())),
